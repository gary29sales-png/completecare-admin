...
if (USE_SUPABASE) {
  ...
  supabase = createClient(SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY, {
    global: {
      ...
      // including ones made internally by third-party libraries like this
      // client. Without this override, a read can come back as a stale
      // cached snapshot even moments after a real write — explicitly
      // forcing no-store on every request this client makes rules that
      // out entirely, regardless of route-level dynamic settings.
